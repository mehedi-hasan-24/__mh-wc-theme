...
<header id="header_area" class="overflow-hidden ">
    ...
    <div class="pc:hidden flex justify-between bg-secondary">
        ...
        <div class="h-screen w-screen pc:hidden hidden bg-black bg-opacity-60 absolute top-0 right-0 z-[1000] gsap-main-nav"
             id="main-nav-overlay">
        ...
        <!-- Menus -->
        <div class="hidden absolute pc:static w-[50%] right-0 pc:w-auto pc:block bg-secondary text-color-third h-screen pc:h-auto z-[1005] gsap-main-nav"
